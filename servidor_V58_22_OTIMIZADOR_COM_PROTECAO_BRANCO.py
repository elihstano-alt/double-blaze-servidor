...
def _optimizer_numba_core(
    ...
    while p < m:
        ...
        for g in range(gale + 1):
            ...
            # O lucro líquido do otimizador já inclui o custo em TODAS as entradas
            # e o retorno 14x quando o resultado real é branco.
...
def main():
    print("V58.22 OTIMIZADOR COM PROTECAO BRANCO + PERSISTENCIA: iniciando servidor...", flush=True)
    carregar_estado()
    with LOCK:
