...
def worker_bootstrap_1500():
    ...
    try:
        ...
        # Executa uma vez por deploy/base. Se já está pronto com >=1500, não refaz.
        if str(estado_boot.get("status", "")) == "pronto" and int(estado_boot.get("quantidade", 0)) >= 1500:
            return
...
def main():
    print("V54.6 Auditoria contínua + Bootstrap 1500 + janela 5000: iniciando servidor...", flush=True)
    carregar_estado()
