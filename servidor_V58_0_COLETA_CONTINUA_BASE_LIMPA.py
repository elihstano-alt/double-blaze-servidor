...
def _optimizer_run_job(job_id, payload):
    ...
    try:
        ...
        cache_payload = {
            "engine": "v57.8-dense-jit-3k-ranking-cache-exact",
            "history": hist_hash,
        ...
        _optimizer_job_update(
            ...
            phase="PREPARANDO MOTOR JIT V57.8",
...
def _optimizer_warmup_background():
    ...
    try:
        ...
        print(
            "V58.0 optimizer JIT pre-aquecido em %.3fs" % (time.time() - t0),
            flush=True
        )
    except Exception as exc:
        print("V58.0 warmup optimizer falhou:", repr(exc), flush=True)


def main():
    print("V58.0 BASE RECENTE AUDITADA + COLETA REDUNDANTE: iniciando servidor...", flush=True)
    carregar_estado()
