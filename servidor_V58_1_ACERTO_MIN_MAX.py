...
def _optimizer_run_job(job_id, payload):
    ...
    try:
        ...
        cache_payload = {
            "engine": "v58.1-rate-min-max-exact",
            "history": hist_hash,
        ...
        _optimizer_job_update(
            ...
            phase="PREPARANDO MOTOR JIT V58.1",
...
def _optimizer_warmup_background():
    ...
    try:
        ...
        print(
            "V58.1 optimizer JIT pre-aquecido em %.3fs" % (time.time() - t0),
            flush=True
        )
    except Exception as exc:
        print("V58.1 warmup optimizer falhou:", repr(exc), flush=True)


def main():
    print("V58.1 ACERTO MIN/MAX + BASE AUDITADA + COLETA REDUNDANTE: iniciando servidor...", flush=True)
    carregar_estado()
