...
def _optimizer_run_job(job_id, payload):
    ...
    try:
        ...
        _optimizer_job_update(
            job_id, status="running", phase="COMPILANDO MOTOR V56.3 (1ª EXECUÇÃO)",
        ...
        _optimizer_job_update(
            job_id, status="running", phase="MOTOR V56.3 PRONTO",
            tested=0, total=total_configs, progress=0.0
        )
            ...
            for mode in modes:
                ...
                for count in range(1, max_count + 1):
                    ...
                    for con in consensuses:
                        ...
                        if tested % 250 == 0:
                            _optimizer_job_update(
                                job_id, phase="VARREDURA EXATA NUMBA V56.3",
                                tested=tested, total=total_configs,
        ...
        _optimizer_job_update(
            job_id, status="done", phase="CONCLUÍDO V56.3",
        ...
        print("Optimizer remoto V56.2 erro:", repr(exc), flush=True)
...
def main():
    print("V56.3 NUMBA EXATO + BRANCO MANUAL: janela 30000 + JIT nativo + cache persistente: iniciando servidor...", flush=True)
    carregar_estado()
