...
def reparar_historico_publico_atual():
    """V54.9: proibido preencher lacunas. Mantém somente sequências realmente observadas."""
    diag = diagnosticar_continuidade_historico()
    return {
        "ok": False,
        "desativado": True,
...
def worker_reparo_inicial():
    # V54.9: reparo automático removido de propósito.
    # Lacunas nunca são preenchidas; um novo bloco contínuo começa após qualquer quebra.
    print("V54.9: preenchimento de lacunas DESATIVADO; usando somente sequência real.", flush=True)
