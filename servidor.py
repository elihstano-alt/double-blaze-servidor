...
def _optimizer_run_job(job_id, payload):
    ...
    try:
        ...
        cache_payload = {
            "engine": "v56.2-numpy-sparse-exact",
        ...
        _optimizer_job_update(
            job_id, status="running", phase="PREPARANDO V56.2 NUMPY",
            ...
            for mode in modes:
                ...
                for count in range(1, max_count + 1):
                    ...
                    for con in consensuses:
                        ...
                        if tested % 250 == 0:
                            _optimizer_job_update(
                                job_id, phase="VARREDURA EXATA NUMPY V56.2",
                                tested=tested, total=total_configs,
        ...
        _optimizer_job_update(
            job_id, status="done", phase="CONCLUÍDO V56.2",
...
def main():
    print("V56.2 NUMPY SPARSE EXATO + BRANCO MANUAL: janela 30000 + cache persistente: iniciando servidor...", flush=True)
    carregar_estado()
